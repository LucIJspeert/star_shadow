...
# execute the code
sts.analyse_from_file(file, p_orb=0, i_sectors=None, method='fitter', data_id=None, overwrite=True, verbose=True)
sts.analyse_from_file(file, p_orb=0, i_sectors=None, method='sampler', data_id=None, overwrite=True, verbose=True)
